...
class FeatureRegistry:
    ...
    FEATURE_FUNCTIONS: Dict[str, Callable] = {
        ...
        'account_age': features.get_account_age,
        'comment_velocity': features.get_comment_velocity,
        'caps_ratio': features.get_caps_percentage,
        'emoji_ratio': features.get_emoji_percentage,
    ...
    DEFAULT_PARAMS: Dict[str, Dict[str, Any]] = {
        ...
        'creation_dates': {},
        'caps_ratio': {'min_comments': 0},
        'emoji_ratio': {'min_comments': 0},
    ...
    DESCRIPTIONS: Dict[str, str] = {
        ...
        'caps_ratio': 'Percentage of words that are all caps',
        'emoji_ratio': 'Percentage of characters that are emojis',
